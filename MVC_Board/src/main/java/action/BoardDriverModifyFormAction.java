...
public class BoardDriverModifyFormAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("BoardDriverModifyFormAction");
		...
		// ActionForward 객체를 사용하여 driver_update.jsp 페이지로 포워딩
		// => 현재 요청 서블릿 주소("BoardDriverModifyForm.bo")를 유지하고,
		//    request 객체를 유지해야하므로 Dispatcher 방식으로 포워딩
		forward = new ActionForward();
		forward.setPath("./driver_update.jsp");
